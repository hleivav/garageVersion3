...
namespace GarageVersion3.Web.Controllers
{
    public class VehicleTypesController : Controller
    {
        ...
        public VehicleTypesController(GarageVersion3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.VehicleType != null ? 
                          ...
                          Problem("Entity set 'GarageVersion3Context.VehicleType'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,KindOfVehicle")] VehicleType vehicleType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,KindOfVehicle")] VehicleType vehicleType)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GarageVersion3Context.VehicleType'  is null.");
            }
            var vehicleType = await _context.VehicleType.FindAsync(id);
            if (vehicleType != null)
            {
